...
(function () {
  ...
  const navItems = [
    ...
    { href: 'gallery.html', label: 'Gallery' },
    {
      ...
      dropdown: [
        { href: 'collections/gold.html', label: 'Gold', img: 'images/collections/gold/feature.jpg' },
        { href: 'collections/silver.html', label: 'Silver', img: 'images/collections/silver/feature.jpg' },
        { href: 'collections/diamond.html', label: 'Diamond', img: 'images/collections/diamond/feature.jpg' },
        { href: 'collections/bridal.html', label: 'Bridal', img: 'images/collections/bridal/feature.jpg' }
      ]
    },
            ...
            if (n.dropdown) {
              const subLinks = n.dropdown.map(d => `
                <a class="nav-dropdown-link" href="${prefix + d.href}">
                  <img class="nav-dropdown-thumb" src="${d.img}" alt="${d.label}" loading="lazy" />
                  <span>${d.label}</span>
                </a>`).join('');
              return `
        ...
        <div class="footer-grid">
          ...
          <div class="footer-col">
            ...
            <ul>
              ...
              <li><span>West maasi street, Madurai, Tamil Nadu</span></li>
            </ul>
